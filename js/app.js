window.onload = () => {
    ...
    const closeModalBtn = document.getElementsByClassName('email-modal__close-btn')[0];
    const emailInputField = document.getElementsByClassName('email-modal__input')[0];
    const emailSendBtn = document.getElementsByClassName('email-modal__button')[0];
    const declineBtn = document.getElementsByClassName('email-modal__decline-offer')[0];
    const errorMsg = document.getElementsByClassName('email-modal__error-msg')[0];
    const emailFormGroup = document.getElementsByClassName('email-modal__form-group')[0];
